...
M = 4 # amount of vertical basis functions to be projected on
...
hydro.solve(advection_epsilon_list, skip_nonlinear=False, maxits=1, tol=1e-7, method='pardiso')
...
postpro.plot_vertical_cross_section(lambda sig: postpro.u_abs(1, sig), "Amplitude of semidiurnal along-channel velocity in central cross-section", 'Velocity [m/s]', p1, p2, 1000, 1000, figsize=(7,4))
postpro.plot_vertical_cross_section(lambda sig: postpro.v_abs(1, sig), "Amplitude of semidiurnal cross-channel velocity in central cross-section", 'Velocity [m/s]', p1, p2, 1000, 1000, figsize=(7,4))
