...
def add_bilinear_part(a: ngsolve.BilinearForm, assumptions: Assumptions, alpha_trialfunctions, beta_trialfunctions, gamma_trialfunctions, 
    ...
    if assumptions.bed_bc == 'no_slip' and assumptions.rigid_lid and assumptions.eddy_viscosity_assumption == 'constant' and assumptions.density == 'depth-independent':
...
def add_nonlinear_part(a: ngsolve.BilinearForm, assumptions: Assumptions, alpha_trialfunctions, beta_trialfunctions, gamma_trialfunctions,
                       umom_testfunctions, vmom_testfunctions, DIC_testfunctions, M, qmax,
    ...
    if assumptions.bed_bc == 'no_slip' and assumptions.rigid_lid and assumptions.eddy_viscosity_assumption == 'constant' and assumptions.density == 'depth-independent':
        return _add_nonlinear_part_NS_RL_EVC_DDI(a, alpha_trialfunctions, beta_trialfunctions, gamma_trialfunctions,
                                                umom_testfunctions, vmom_testfunctions, DIC_testfunctions, M, qmax,
                                                constant_parameters, spatial_parameters, vertical_basis, time_basis, normalalpha, advection_weighting_parameter, n)


def add_linearised_nonlinear_part(a: ngsolve.BilinearForm, assumptions: Assumptions, alpha_trialfunctions, beta_trialfunctions, gamma_trialfunctions,
